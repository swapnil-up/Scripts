...
def create_gif(input_file, output_file, start=None, duration=None,
    ...
    Output goes to current working directory by default.
    """
    ...
    try:
        ...
        if size_mb > 10:
            print("\n⚠ Warning: GIF is large (>10 MB). Consider:")
            print("  --quality low  |  shorter duration  |  --width 480  |  --fps 10")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        print("  --width WIDTH       Output width in pixels (height auto-scaled)")
